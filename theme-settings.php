 ...
 * theme-settings.php
 *
 * Provides theme settings for BioData.pt
 */
 ...
 */
function biodatapt_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  foreach ($biodatapt_contained_regions as $contained_region_name => $contained_region_title) {
